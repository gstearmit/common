...
/**
 * This is the model class for table "product_ebay".
 *
 * @property integer $id
 ...
 */
class ProductEbay extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['Sku'], 'string', 'max' => 400],
            [['Name', 'MetaKeywords', 'MetaDescription', 'MetaTitle', 'ThumbUrl', 'ImageUrl', 'OriginalUrl'], 'string', 'max' => 255],
            [['Brand'], 'string', 'max' => 50],
